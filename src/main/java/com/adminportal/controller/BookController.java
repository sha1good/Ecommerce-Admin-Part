...
//	private String maxFileSize;
	...
	public String addBookPost(
	    	@ModelAttribute("book")	@Valid Book book, BindingResult result, HttpServletRequest request) {

//		long bookLong = book.getBookImage().getSize();
//		int bookInt = Math.toIntExact(bookLong);
//
//		if(bookInt > maxFileSize.length()){
...
//		String name= request.getParameter(book.getId() + "");
	...
	public String updateBook(@ModelAttribute("book") Book book, HttpServletRequest request) {
		...
		if(! bookImage.isEmpty()) {
			try {
				...
				System.out.println("Error Uplaoding the file  from BookController 1....");
				e.printStackTrace();
			}
		}
